...
public class ComboBoxModerna<E> extends JComboBox<E> {
    ...
    private class ComboBoxModernaUI extends javax.swing.plaf.basic.BasicComboBoxUI {
        ...
        protected JButton createArrowButton() {
            ...
            button.setIcon(new ImageIcon(Home.class.getResource("/br/edu/paulista/ifpe/model/images/iconeComboBox.png")));
        ...
        protected ComboPopup createPopup() {
            return (ComboPopup) new ModernComboPopup(comboBox); // Use the custom ModernComboPopup
        }
    }
	...
	private class ModernComboPopup extends BasicComboPopup {
        ...
        protected JScrollPane createScroller() {
            ...
            scroller.getVerticalScrollBar().setUI(new ModernScrollBarUI()); // Use the custom ModernScrollBarUI
