package br.edu.paulista.ifpe.core.util.cadastroPacientes;
...
public class InserirPaciente {
	...
	public void inserirDados(String nome, String cpf, String rg, String telefone, String email, String rua,
            String numero, String complemento, String bairro, String cep, String cidade, String uf,
            String nascimento, String sexo, String estadoCivil, String nomePai, String nomeMae) {
