...
public class HomeMedico extends JFrame {
	...
	public HomeMedico(String nomeAutenticado) {
        ...
        btnReceita.setIcon(new ImageIcon(Home.class.getResource("/br/edu/paulista/ifpe/model/images/iconeReceita.png")));
        ...
        btnRequisicaoExame.setIcon(new ImageIcon(Home.class.getResource("/br/edu/paulista/ifpe/model/images/iconeReqExame.png")));
