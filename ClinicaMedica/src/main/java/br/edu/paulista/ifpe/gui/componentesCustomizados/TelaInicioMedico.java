...
public class TelaInicioMedico extends JPanel {
	...
	public TelaInicioMedico(int id) {
		setLayout(null);
		this.id = id;
		...
		paciente1TableModel.adicionarConsultasEExamesPorMedico(id);
		...
		pacienteTableModel.adicionarConsultasEExamesPorMedico(id);
		...
		grafico = new PainelGraficoMedico(id);
